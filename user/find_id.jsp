...
<%
    ...
    int findtype = Integer.parseInt(request.getParameter("type"));
    String driverName = "org.gjt.mm.mysql.Driver";
    String dbURL = "jdbc:mysql://localhost:3306/mysql29";
    String sql;
    if (findtype == 1) {
        sql = "select * from user where US_NA = '" + username + "' AND US_PN = '" + userphone + "'";
    }else{
        sql = "select * from user where US_NA = '" + username + "' AND US_EM = '" + useremail + "'";
...
<body>
    ...
    <%
    	...
    	out.println("아이디 조회에 문제가 있습니다. <hr>");
