...
<head>
    <%
        ...
        String re_num = request.getParameter("no");
    %>
    <meta charset="UTF-8">
    <title>그루, GROW</title>
     ...
     <b> <a> <div id="commu_text1"> &nbsp; 마이 페이지 </div> </a> <br>
        ...
        <div class="board_list_wrap">
            ...
            <table class="board_list">
                ...
                String sql = "select * from user_request where US_ID = '" + userid + "' AND US_RF = '" + re_num + "'";
                int count = 0;
                ...
                %>
                    <tr>
                        ...
                        <td style="font-size: 15pt; font-family: ff;" colspan="2">
                            <%=result.getString(3)%>
                        </td>
                    ...
                    <tr height="300px">
                        <th>내용</th>
                        <td colspan="3"; style="font-size: 15pt;"><%=result.getString(4)%></td>
                    </tr>
                <%
                    count++;
                }
