    ...
    <div id="commu">
     <b> <a> <div id="commu_text1"> &nbsp; 마이 페이지 </div> </a> <br>
        ...
        <div class="board_list_wrap">
            ...
            <table class="board_list">
                ...
                %>
                    <tr>
                        ...
                        <td class="tit">
                            <a href="apply_detail.jsp?no=<%= result.getInt(2)%>"> <%=result.getString(3)%> </a>
                        </td>
                        <td><%=result.getDate(5)%></td>
                        <td><input type="button" value="수정" style="display: inline;" onclick="location.href='apply_edit.jsp?no=<%= result.getInt(2)%>';">&nbsp; <input type="button" value="삭제"  style="display: inline;" onclick="location.href='apply_delete.jsp?no=<%= result.getInt(2)%>';"></td> 
                    </tr>
                <%
                    count++;
                }
            ...
            <br>
                <input type="button" value="글쓰기" class="next" style="cursor: pointer;" onclick="location.href='apply_write.html';">
            <div class="paging">
